                                ...
                                <h2>Clients</h2><div class="scrollable">
                                    <table class="table table-striped" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach items="${requestScope.histotyTransaction}" var="od">
                                                <tr>
                                                    <td><img src="${od.user.image}" width="32" height="32" class="rounded-circle my-n1" alt="Avatar"></td>
                                                    <td>${od.user.name}</td>
                                                    <td>${od.dateOrder}</td>
                                                    <td><span class="badge bg-success">done</span></td>
                                                    <td><a class="btn-block" href="histotyTransaction?id=${od.id}">More detail</a></td>
                                                    <td><a class="btn-block" href="histotyTransaction?id_delete=${od.id}">delete</a></td>
                                                </tr>  
                                            </c:forEach>
                            ...
                            <c:if test="${requestScope.Orderdetail!=null}"> 
                                <div class="card-body">
                                    ...
                                    <ul class="timeline mt-2 mb-0">
                                        <c:forEach items="${requestScope.OrderdetailList}" var="old">
                                            <li class="timeline-item">(${old.quantity} item) ${old.product.name}</li>     
                                            </c:forEach>
